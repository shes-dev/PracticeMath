...
class solution 
{
	...
	public function __construct($solution_array)
	{
		...
		else if ($this->solutionAdVideoFlag)
		{
...
<div class="w3-teal">
  ...
  <div class="w3-container w3-center">
    <h1 style="margin-top:0px;">מתמטיקה |3|4|5 יח"ל</h1>
  </div>
</div>
		';
	}
...
<div class="w3-container w3-center">
  <h2 style="margin-top:10px;">'.$subjectName.'</h2>
	<div class="w3-bar w3-border w3-round pagination" style="width:auto;display:inline-block;text-align:center;">
		...
		<button class="w3-bar-item w3-button padding-8x-16px green-hover" style="padding:8px 16px;text-decoration:none;">4</button>
...
<div class="w3-row w3-container w3-center">
   <div class="w3-row">
    <div id="div2" class="w3-col l6 m6 s0 w3-center">
...
$(document).ready(function(){
  $("#button01").click(function(){
    ...
    $.ajax({url: "solution_01.php", success: function(result){
      $("#div2").html(result);
	  
		$.ajax({url: "questions_01.php", success: function(result){
			 $("#div1").html(result);
		}});
	}});
  });
  ...
  $("#button02").click(function(){
	...
	$.ajax({url: "solution_02.php", success: function(result){
      $("#div2").html(result);
	  
		$.ajax({url: "questions_02.php", success: function(result){
			 $("#div1").html(result);
		}});
	}});
  });
  ...
  $("#button03").click(function(){
    ...
    $.ajax({url: "solution_03.php", success: function(result){
      $("#div2").html(result);
	  
		$.ajax({url: "questions_03.php", success: function(result){
			 $("#div1").html(result);
		}});
	}});
  });
