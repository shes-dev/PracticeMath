...
<div class="w3-container w3-center">
  <h2 style="margin-top:10px;">חיבור, חיסור, כפל, חילוק שברים</h2>
	<div class="w3-bar w3-border w3-round pagination" style="width:auto;display:inline-block;text-align:center;">
		<a href="#" class="w3-bar-item w3-button padding-8x-16px green-hover" style="padding:8px 16px;text-decoration:none;">&raquo;</a>
		<a href="#" class="w3-bar-item w3-button padding-8x-16px green-hover" style="padding:8px 16px;text-decoration:none;">1</a>
		<a href="#" class="w3-bar-item w3-button padding-8x-16px green-hover" style="padding:8px 16px;text-decoration:none;">2</a>
...
<?php
	...
	$subjectDisplay = new subjectHeader();
...
?>
		...
		<?php 	
				...
				[
					'demoNumber' => '1',
					'secondaryDemoNumber' => '6',
					'thirdDemoNumber' => '2',
					'imgName' => '001.jpg',
					'questionName' => 'חיבור',
					'questionTag' => 'חיבור שברים',
					'questionTagColor' => 'green',
					'questionNumber' => '000-000-001',
					'solutionMathjax' => '$$\frac{3}{4}+\frac{2}{3}=1\frac{5}{12}$$',
					'fullSolutionMathjax' => '$$\frac{3}{4}+\frac{2}{3}=\frac{9}{12}+\frac{8}{12}=\frac{9+8}{12}=\frac{17}{12}=1\frac{5}{12}$$'
				];
				$solutionDisplay = new solution($solution_array);
				...
				[
					'demoNumber' => '3',
					'secondaryDemoNumber' => '7',
					'thirdDemoNumber' => '4',
					'imgName' => '002.jpg',
					'questionName' => 'כפל',
					'questionTag' => 'כפל שברים',
					'questionTagColor' => 'purple',
					'questionNumber' => '000-000-002',
					'solutionMathjax' => '$$\frac{3}{4}\times\frac{2}{3}=\frac{1}{2}$$',
					'fullSolutionMathjax' => '$$\frac{3}{4}\times\frac{2}{3}=\frac{3\times2}{4\times3}=\frac{6}{12}=\frac{1}{2}$$'
				];
				$solutionDisplay = new solution($solution_array);
				$solutionDisplay->displayContent();
				...
				[
					'demoNumber' => '003_1',
					'secondaryDemoNumber' => '003_2',
					'thirdDemoNumber' => '003_3',
					'imgName' => '003.jpg',
					'questionName' => 'חיסור',
					'questionTag' => 'חיסור שברים',
					'questionTagColor' => 'blue',
					'questionNumber' => '000-000-003',
					'solutionMathjax' => '$$\frac{9}{7}-\frac{5}{4}=\frac{1}{28}$$',
					'fullSolutionMathjax' => '$$\frac{9}{7}-\frac{5}{4}=\frac{36}{28}-\frac{35}{28}=\frac{1}{28}$$'
				];
				$solutionDisplay = new solution($solution_array);
				$solutionDisplay->displayContent();
				...
				[
					'demoNumber' => '004_1',
					'secondaryDemoNumber' => '004_2',
					'thirdDemoNumber' => '004_3',
					'imgName' => '004.jpg',
					'questionName' => 'חילוק',
					'questionTag' => 'חילוק שברים',
					'questionTagColor' => 'red',
					'questionNumber' => '000-000-004',
					'solutionMathjax' => '$$\frac{\frac{1}{2}}{\frac{3}{4}}=\frac{1}{28}$$',
					'fullSolutionMathjax' => '$$\frac{\frac{1}{2}}{\frac{3}{4}}=\frac{1}{2}\times\frac{4}{3}=\frac{1\times4}{2\times3}=\frac{4}{6}=\frac{2}{3}$$'
				];
				$solutionDisplay = new solution($solution_array);
				$solutionDisplay->displayContent();
		?>
		...
		<ul class="w3-ul w3-card-4">
			<?php
				...
				[
					...
					'questionTagColor' => 'green',
					'questionNumber' => '000-000-001',
					'descriptionText' => 'התחלה רגועה',
					'questionMathjax' => '$$\frac{3}{4}+\frac{2}{3}$$'
				];
				
				$questionDisplay = new question($question_array);
				...
				[
					...
					'questionTagColor' => 'purple',
					'questionNumber' => '000-000-002',
					'descriptionText' => '2 ברווזים נכנסים לבית קפה. האחד שואל:"מה להביא לך לשתות?" השני עונה לו:"קוואק".',
					'questionMathjax' => '$$\frac{3}{4}\times\frac{2}{3}$$'
				];
				...
				[
					...
					'questionTagColor' => 'blue',
					'questionNumber' => '000-000-003',
					'descriptionText' => 'היקף העולם הוא בערך 40,000 ק"מ.',
					'questionMathjax' => '$$\frac{9}{7}-\frac{5}{4}$$'
				];
				...
				[
					...
					'questionTagColor' => 'red',
					'questionNumber' => '000-000-004',
					'descriptionText' => 'חילוק שברים בונה אופי.',
					'questionMathjax' => '$$\frac{\frac{1}{2}}{\frac{3}{4}}$$'
				];
