		...
		<div class="w3-container w3-hide Demo1 padding-left-zero">
			...
			<ul class="w3-ul w3-card-4 w3-margin-bottom">
				<li class="w3-bar" style="width:100%;">
					<img src="001.jpg" class="w3-bar-item w3-circle /*w3-hide-small*/" style="width:68px">
					<div class="w3-bar-item w3-right">
						<span class="w3-large">חיבור | </span>
						<span>000-000-001</span>
						<p class="margin-bottom-0px">
							<span class="w3-tag w3-blue">3 יח"ל</span>
							<span class="w3-tag w3-green">חיבור</span>
							<span class="w3-tag w3-purple">חיסור</span>
						</p>
						<span>פיתרון</span>
					</div>
				</li>
		...
		<div class="w3-container w3-hide Demo3 padding-left-zero">
			<ul class="w3-ul w3-card-4 w3-margin-bottom">
				<li class="w3-bar" style="width:100%;">
					...
					<div class="w3-bar-item w3-right">
						<span class="w3-large">כפל וחילוק | </span>
						<span>000-000-002</span><br>
						<p class="margin-bottom-0px">
							<span class="w3-tag w3-blue">3 יח"ל</span>
							<span class="w3-tag w3-green">כפל</span>
							<span class="w3-tag w3-purple">חילוק</span>
						</p>
						<span>פיתרון</span>
					</div>
				</li>
			...
			<div class="w3-card-4 w3-margin-bottom" style="width:100%">
				<!-- <img src="05.jpg" alt="Alps" style="width:100%"> -->
				<div onclick="myFunction('Demo4')" class="w3-container w3-center">
				<p>$$\frac{5}{12}$$</p>
				</div>
		...
		<ul class="w3-ul w3-card-4">
			...
			<li class="w3-bar w3-hide Demo5" style="width:100%;">
				...
				<form class="w3-container w3-card-4">
					...
					<p class="align-right margin-bottom-0px">      
						<label class="w3-text-grey margin-bottom-0px">בחירת תגיות</label>
					</p>
									
					<div class="w3-row">
						<div class="w3-half w3-right align-right">
							...
							<label>פונקציות</label>
							<br><br>
						</div>
					
						<div class="w3-half w3-left align-right">
							<input id="milk_02" class="w3-check" type="checkbox" checked="checked">
							<label>3 יח"ל</label>
							<br>
							<input id="sugar_02" class="w3-check" type="checkbox">
							<label>4 יח"ל</label>
							<br>
							<input id="lemon_02" class="w3-check" type="checkbox">
							<label>5 יח"ל</label>
							<br><br>
						</div>
					</div>
					<p><button type="button" class="w3-btn w3-padding w3-teal" style="width:120px">שלח &nbsp; &#10095;</button></p>
				</form>
			</li>
		</ul>
	</div>
