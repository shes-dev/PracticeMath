...
<div class="w3-container w3-center">
  <h2>בחר/י איזה שאלה שבא לך</h2>
</div>

<div class="w3-row w3-container w3-center">
   <div class="w3-row">
    <div class="w3-col l6 m6 s0 w3-center">
		<div class="w3-container w3-hide Demo1 padding-left-zero">
			
			<ul class="w3-ul w3-card-4 w3-margin-bottom">
				<li class="w3-bar" style="width:100%;">
					<img src="001.jpg" class="w3-bar-item w3-circle" style="width:68px">
					<div onclick="myFunction('Demo6')" class="w3-bar-item w3-right">
						<span class="w3-large">חיבור | </span>
						<span>000-000-001</span>
						<p class="margin-bottom-0px">
							<span class="w3-tag w3-green">חיבור שברים</span>
						</p>
			...
			<div class="w3-card-4 w3-margin-bottom w3-hide Demo6" style="width:100%">
				<!-- <img src="05.jpg" alt="Alps" style="width:100%"> -->
				<div onclick="myFunction('Demo2')" class="w3-container w3-center">
				<p>$$\frac{3}{4}+\frac{2}{3}=1\frac{5}{12}$$</p>
				</div>
				
				<div class="w3-container w3-hide Demo2">
					<div style="width:75%;margin:auto;">
						<hr>
					</div>
					<p>$$\frac{3}{4}+\frac{2}{3}=\frac{9}{12}+\frac{8}{12}=\frac{9+8}{12}=\frac{17}{12}=1\frac{5}{12}$$</p>
				</div>
			</div>
		</div>
		
		<div class="w3-container w3-hide Demo3 padding-left-zero">
			<ul class="w3-ul w3-card-4 w3-margin-bottom">
				<li class="w3-bar" style="width:100%;">
					<img src="002.jpg" class="w3-bar-item w3-circle /*w3-hide-small*/" style="width:68px">
					<div onclick="myFunction('Demo7')" class="w3-bar-item w3-right">
						<span class="w3-large">כפל |</span>
						<span>000-000-002</span><br>
						<p class="margin-bottom-0px">
							<span class="w3-tag w3-purple">כפל שברים</span>
						</p>
						<span>לחצ/י לפיתרון</span>
					</div>
				</li>
			...
			<div class="w3-card-4 w3-margin-bottom w3-hide Demo7" style="width:100%">
				<!-- <img src="05.jpg" alt="Alps" style="width:100%"> -->
				<div onclick="myFunction('Demo4')" class="w3-container w3-center direction-ltr">
					<p>$$\frac{3}{4}\times\frac{2}{3}=\frac{1}{2}$$</p>
				</div>
				
				<div class="w3-container w3-hide Demo4">
					<div style="width:75%;margin:auto;">
						<hr>
					</div>
					<p>$$\frac{3}{4}\times\frac{2}{3}=\frac{3\times2}{4\times3}=\frac{6}{12}=\frac{1}{2}$$</p>
					<!--<img src="05.jpg" class="w3-bar-item" style="width:100%;margin-bottom:16px;">-->
				</div>
			</div>
		</div>
	...
	<div class="w3-col l6 m6 s12 w3-center" style="float:right;">
		<ul class="w3-ul w3-card-4">
			<li class="w3-bar" onclick="myFunction('Demo1')" style="width:100%;">
				<div class="w3-col" style="width:68px">
					<img src="001.jpg" class="w3-bar-item w3-circle" style="width:100%">
				</div>
				...
				<div class="w3-rest">
					<div class="w3-bar-item w3-right">
						...
						<span>התחלה רגועה</span>
					</div>
				</div>
				
				<div class="w3-container w3-hide Demo1">
					<div style="width:75%;margin:auto;">
						<hr>
					</div>
					$$\frac{3}{4}+\frac{2}{3}$$
					<!-- <img src="05.jpg" class="w3-bar-item" style="width:100%"> -->
				</div>
			</li>
		
			<li class="w3-bar" onclick="myFunction('Demo3')" style="width:100%;">
				<div class="w3-col" style="width:68px">
					<img src="002.jpg" class="w3-bar-item w3-circle /*w3-hide-small*/" style="width:100%">
				</div>
				...
				<div class="w3-rest">
					<div class="w3-bar-item w3-right">
						...
						<span>2 ברווזים נכנסים לבית קפה. האחד שואל:"מה להביא לך לשתות?" השני עונה לו:"קוואק".</span>
					</div>
				</div>
				
				<div class="w3-container w3-hide Demo3">
					<div style="width:75%;margin:auto;">
						<hr>
					</div>
			...
			<li class="w3-bar" style="width:100%;">
				<img src="003.jpg" class="w3-bar-item w3-circle" style="width:68px">
				<div class="w3-bar-item w3-right">
					<span class="w3-large">חזקה ושורש</span><br>
			...
			<li class="w3-bar" style="width:100%;">
				...
				<div class="w3-bar-item">
					<img onclick="myFunction('Demo5')" src="Plus.jpg" class="w3-bar-item w3-circle" style="width:63px;margin-left:3px;">
				</div>
			</li>
			...
			<li class="w3-bar w3-hide Demo5" style="width:100%;">
				...
				<form class="w3-container w3-card-4">
					<p class="align-right margin-bottom-0px">      
						...
						<p class="align-right margin-bottom-0px">לציין שם שאלה, תיאור קצר (בשורה) ופתרון מלא.</p>
						<!-- FORM 01 -->
